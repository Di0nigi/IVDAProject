...
– Include annotated screenshots of relevant code sections, visualizations made during the data wrangling
process, etc

\section{Visual Interface} (All)
A description of the decisions made on visual encoding decisions and the interactions used in your VA
tool (0.5 point)
– A description of how your defined user tasks relate to your visual interface, and all of its encodings and
interactions (0.5 point)
...
– A summary of the feedback you received on your final presentation. Supplement this feedback with a
self-reflection on this aspect. (0.5 point)
– Identification of the limitations you agree would be relevant to address, with a discussion on how they
might be addressed in a hypothetical future iteration of your work. Focus on feedback regarding whether
your tasks were effectively supported by your data preprocessing and modeling choices, and by your tool.
(2 points)
...
– A flowchart summarizing this information, including data, human and AI agents, and components of
your enhanced IVDA system
