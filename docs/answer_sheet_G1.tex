...
provide an ML based overall score as well.
    \item Tag relationships -- In order to record their own train of thought and help organize their research, users need
...
%1
\begin{itemize}
    \item Gain overview: We will use a timeline with
          colored background blocks and works plotted into this, a block of title, author and
    ...
    \item Filter by attributes; We will provide a search function by title or author for
          ...
          histograms.
    \item Judge reliability: We will present the user with a score represented
          as a colored bar, as well as the attributes contributing to this.
