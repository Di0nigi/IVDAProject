...
In the course of our study we will follow and refer to Tamara Munzner nomeclature \cite{munzner2014visualization}.
...
\begin{figure}[H]
    ...
    \caption{The user defineable bar chart.}
    \label{fig:bar_chart}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{cluster_plot.png}
    \caption{The cluster plot.}
    \label{fig:cluster plot}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{detail_view.png}
    \caption{The detailed example preview of a single item}
    \label{fig:detail_view}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{global_filters.png}
    \caption{global filter settings component.}
    \label{fig:global_filter}
\end{figure}


\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{relation_graph.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{list.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{reliability_score_settings.png}
...
\begin{figure}[H]
    ...
    \caption{The collected dashboard across all visualisations.}
    \label{fig: dashboard}
\end{figure}
