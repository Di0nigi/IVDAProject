...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{bar chart.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{cluster_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{detail_view.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{global_filter.png}
